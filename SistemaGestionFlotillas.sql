...
--
-- Temporary view structure for view `conductoresactivos`
--

DROP TABLE IF EXISTS `conductoresactivos`;
/*!50001 DROP VIEW IF EXISTS `conductoresactivos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `conductoresactivos` AS SELECT 
 1 AS `conductorId`,
 1 AS `nombre`,
 1 AS `numeroLicencia`,
...
--
-- Temporary view structure for view `conductoresconvehiculos`
--

DROP TABLE IF EXISTS `conductoresconvehiculos`;
/*!50001 DROP VIEW IF EXISTS `conductoresconvehiculos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `conductoresconvehiculos` AS SELECT 
 1 AS `conductorId`,
...
--
-- Temporary view structure for view `conductoresinactivos`
--

DROP TABLE IF EXISTS `conductoresinactivos`;
/*!50001 DROP VIEW IF EXISTS `conductoresinactivos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `conductoresinactivos` AS SELECT 
 1 AS `conductorId`,
 1 AS `nombre`,
 1 AS `numeroLicencia`,
 1 AS `vencimientoLicencia`,
...
--
-- Temporary view structure for view `documentosvencidos`
--

DROP TABLE IF EXISTS `documentosvencidos`;
/*!50001 DROP VIEW IF EXISTS `documentosvencidos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `documentosvencidos` AS SELECT 
 1 AS `documentoId`,
 1 AS `vehiculoId`,
 1 AS `tipo`,
...
--
-- Temporary view structure for view `documentosvigentes`
--

DROP TABLE IF EXISTS `documentosvigentes`;
/*!50001 DROP VIEW IF EXISTS `documentosvigentes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `documentosvigentes` AS SELECT 
 1 AS `documentoId`,
 1 AS `vehiculoId`,
 1 AS `tipo`,
 1 AS `fechaVencimiento`,
...
--
-- Temporary view structure for view `flotillasconvehiculos`
--

DROP TABLE IF EXISTS `flotillasconvehiculos`;
/*!50001 DROP VIEW IF EXISTS `flotillasconvehiculos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `flotillasconvehiculos` AS SELECT 
 1 AS `flotillaId`,
 1 AS `nombreEmpresa`,
 1 AS `vehiculoId`,
 1 AS `marca`,
...
--
-- Temporary view structure for view `mantenimientoscompletados`
--

DROP TABLE IF EXISTS `mantenimientoscompletados`;
/*!50001 DROP VIEW IF EXISTS `mantenimientoscompletados`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `mantenimientoscompletados` AS SELECT 
...
--
-- Temporary view structure for view `mantenimientosconvehiculos`
--

DROP TABLE IF EXISTS `mantenimientosconvehiculos`;
/*!50001 DROP VIEW IF EXISTS `mantenimientosconvehiculos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `mantenimientosconvehiculos` AS SELECT 
 1 AS `mantenimientoId`,
 1 AS `fechaServicio`,
 1 AS `tipoServicio`,
 1 AS `costo`,
...
--
-- Temporary view structure for view `mantenimientospendientes`
--

DROP TABLE IF EXISTS `mantenimientospendientes`;
/*!50001 DROP VIEW IF EXISTS `mantenimientospendientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `mantenimientospendientes` AS SELECT 
 1 AS `mantenimientoId`,
 1 AS `vehiculoId`,
 1 AS `fechaServicio`,
 1 AS `tipoServicio`,
...
--
-- Temporary view structure for view `rutascompletadas`
--

DROP TABLE IF EXISTS `rutascompletadas`;
/*!50001 DROP VIEW IF EXISTS `rutascompletadas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutascompletadas` AS SELECT 
 1 AS `rutaId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `horaInicio`,
...
--
-- Temporary view structure for view `rutasencurso`
--

DROP TABLE IF EXISTS `rutasencurso`;
/*!50001 DROP VIEW IF EXISTS `rutasencurso`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutasencurso` AS SELECT 
 1 AS `rutaId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `horaInicio`,
...
--
-- Temporary view structure for view `transaccionescombustiblecondetalles`
--

DROP TABLE IF EXISTS `transaccionescombustiblecondetalles`;
/*!50001 DROP VIEW IF EXISTS `transaccionescombustiblecondetalles`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `transaccionescombustiblecondetalles` AS SELECT 
 1 AS `transaccionId`,
...
--
-- Temporary view structure for view `vehiculoscondocumentos`
--

DROP TABLE IF EXISTS `vehiculoscondocumentos`;
/*!50001 DROP VIEW IF EXISTS `vehiculoscondocumentos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculoscondocumentos` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `marca`,
 1 AS `modelo`,
 1 AS `documentoId`,
...
--
-- Temporary view structure for view `vehiculosenmantenimiento`
--

DROP TABLE IF EXISTS `vehiculosenmantenimiento`;
/*!50001 DROP VIEW IF EXISTS `vehiculosenmantenimiento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculosenmantenimiento` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Temporary view structure for view `vehiculosenruta`
--

DROP TABLE IF EXISTS `vehiculosenruta`;
/*!50001 DROP VIEW IF EXISTS `vehiculosenruta`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculosenruta` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Final view structure for view `conductoresactivos`
--
...
/*!50001 VIEW `conductoresactivos` AS select `conductor`.`conductorId` AS `conductorId`,`conductor`.`nombre` AS `nombre`,`conductor`.`numeroLicencia` AS `numeroLicencia`,`conductor`.`vencimientoLicencia` AS `vencimientoLicencia`,`conductor`.`estado` AS `estado` from `conductor` where (`conductor`.`estado` = 'Activo') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `conductoresconvehiculos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `conductoresconvehiculos` AS select `c`.`conductorId` AS `conductorId`,`c`.`nombre` AS `nombreConductor`,`c`.`numeroLicencia` AS `numeroLicencia`,`v`.`vehiculoId` AS `vehiculoId`,`v`.`marca` AS `marca`,`v`.`modelo` AS `modelo` from ((`conductor` `c` join `ruta` `r` on((`c`.`conductorId` = `r`.`conductorId`))) join `vehiculo` `v` on((`r`.`vehiculoId` = `v`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `conductoresinactivos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `conductoresinactivos` AS select `conductor`.`conductorId` AS `conductorId`,`conductor`.`nombre` AS `nombre`,`conductor`.`numeroLicencia` AS `numeroLicencia`,`conductor`.`vencimientoLicencia` AS `vencimientoLicencia`,`conductor`.`estado` AS `estado` from `conductor` where (`conductor`.`estado` = 'Inactivo') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `documentosvencidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `documentosvencidos` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`vehiculoId` AS `vehiculoId`,`documento`.`tipo` AS `tipo`,`documento`.`fechaVencimiento` AS `fechaVencimiento`,`documento`.`estado` AS `estado`,`documento`.`rutaArchivo` AS `rutaArchivo` from `documento` where (`documento`.`estado` = 'Vencido') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `documentosvigentes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `documentosvigentes` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`vehiculoId` AS `vehiculoId`,`documento`.`tipo` AS `tipo`,`documento`.`fechaVencimiento` AS `fechaVencimiento`,`documento`.`estado` AS `estado`,`documento`.`rutaArchivo` AS `rutaArchivo` from `documento` where (`documento`.`estado` = 'Vigente') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `flotillasconvehiculos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `flotillasconvehiculos` AS select `f`.`flotillaId` AS `flotillaId`,`f`.`nombreEmpresa` AS `nombreEmpresa`,`v`.`vehiculoId` AS `vehiculoId`,`v`.`marca` AS `marca`,`v`.`modelo` AS `modelo`,`v`.`anio` AS `anio` from (`flotilla` `f` join `vehiculo` `v` on((`f`.`flotillaId` = `v`.`flotillaId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `mantenimientoscompletados`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mantenimientosconvehiculos` AS select `m`.`mantenimientoId` AS `mantenimientoId`,`m`.`fechaServicio` AS `fechaServicio`,`m`.`tipoServicio` AS `tipoServicio`,`m`.`costo` AS `costo`,`v`.`vehiculoId` AS `vehiculoId`,`v`.`marca` AS `marca`,`v`.`modelo` AS `modelo` from (`mantenimiento` `m` join `vehiculo` `v` on((`m`.`vehiculoId` = `v`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `mantenimientospendientes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rutascompletadas` AS select `ruta`.`rutaId` AS `rutaId`,`ruta`.`vehiculoId` AS `vehiculoId`,`ruta`.`conductorId` AS `conductorId`,`ruta`.`horaInicio` AS `horaInicio`,`ruta`.`horaFin` AS `horaFin`,`ruta`.`distancia` AS `distancia`,`ruta`.`ubicacionInicio` AS `ubicacionInicio`,`ruta`.`ubicacionFin` AS `ubicacionFin`,`ruta`.`estado` AS `estado` from `ruta` where (`ruta`.`estado` = 'Completada') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rutasencurso`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rutasencurso` AS select `ruta`.`rutaId` AS `rutaId`,`ruta`.`vehiculoId` AS `vehiculoId`,`ruta`.`conductorId` AS `conductorId`,`ruta`.`horaInicio` AS `horaInicio`,`ruta`.`horaFin` AS `horaFin`,`ruta`.`distancia` AS `distancia`,`ruta`.`ubicacionInicio` AS `ubicacionInicio`,`ruta`.`ubicacionFin` AS `ubicacionFin`,`ruta`.`estado` AS `estado` from `ruta` where (`ruta`.`estado` = 'En Curso') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `transaccionescombustiblecondetalles`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `transaccionescombustiblecondetalles` AS select `t`.`transaccionId` AS `transaccionId`,`t`.`fechaTransaccion` AS `fechaTransaccion`,`t`.`cantidad` AS `cantidad`,`t`.`tipoCombustible` AS `tipoCombustible`,`c`.`conductorId` AS `conductorId`,`c`.`nombre` AS `nombreConductor`,`v`.`vehiculoId` AS `vehiculoId`,`v`.`marca` AS `marca`,`v`.`modelo` AS `modelo` from ((`transaccioncombustible` `t` join `conductor` `c` on((`t`.`conductorId` = `c`.`conductorId`))) join `vehiculo` `v` on((`t`.`vehiculoId` = `v`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculoscondocumentos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculoscondocumentos` AS select `v`.`vehiculoId` AS `vehiculoId`,`v`.`marca` AS `marca`,`v`.`modelo` AS `modelo`,`d`.`documentoId` AS `documentoId`,`d`.`tipo` AS `tipoDocumento`,`d`.`fechaVencimiento` AS `fechaVencimiento` from (`vehiculo` `v` join `documento` `d` on((`v`.`vehiculoId` = `d`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculosenmantenimiento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculosenruta` AS select `vehiculo`.`vehiculoId` AS `vehiculoId`,`vehiculo`.`flotillaId` AS `flotillaId`,`vehiculo`.`tipo` AS `tipo`,`vehiculo`.`modelo` AS `modelo`,`vehiculo`.`marca` AS `marca`,`vehiculo`.`anio` AS `anio`,`vehiculo`.`estado` AS `estado`,`vehiculo`.`fechaVerificacion` AS `fechaVerificacion` from `vehiculo` where (`vehiculo`.`estado` = 'En Ruta') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-03-13 15:34:27
